...
<body>
    <nav class="bg-blue-900 h-[70px] flex items-center justify-between px-5 z-30 w-full relative">
        ...
        <img src="../img/logo BPS 2 icon.png" alt="" width="45px">
        <div class="text-white px-2 mb-2 ml-2">
            <div class="font-bold text-md lg:text-md font-sans">Badan Pusat Statistik</div>
            <div class="lg:text-xs text-xs font-sans">Kabupaten Pulang Pisau</div>
        </div>
        </div>
